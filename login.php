...
<div class="card z-depth-3 col-md-6 offset-md-3 animated zoomIn">
    <div class="card-block">
        ...
        <div class="text-center">
            <button class="btn btn-deep-purple" name="login" type="submit">Login</button>
        </div>
        </form>
<?php
            $conn    = Connect();
            if(isset($_POST['login']))
            {
                ...
                $sqlget = "SELECT * FROM register_tb where username='$username' and password='$password' ";
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-lg-2 col-lg-push-1 ">
                    <h5 class="h5-responsive white-text"><a href="startup.html">About</a></h5>
                    <ul class="foxo-footer-links">
                        <li><a href="startup.html#foxo-startup" class="text-fluid white-text">Lean MVP GENIE</a></li>
                        <li><a href="services.html#foxo-services-web" class="text-fluid white-text">Web Apps</a></li>
                        <li><a href="services.html#foxo-services-mobile" class="text-fluid white-text">Client Speak</a></li>
                    </ul>
                </div>
